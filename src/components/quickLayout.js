...
const QuickLayout = () => {
  ...
  return (
      <ul className={quickMenu_Links}>
          <CategoryLayout link="/product/list" src={SportIcon}>스포츠</CategoryLayout>
          <CategoryLayout link="/product/list" src={ClothIcon}>패션의류</CategoryLayout>          
          <CategoryLayout link="/product/list" src={MobileIcon}>모바일/태블릿</CategoryLayout>
